return -- lazy.nvim
{
  ...
  config = function()
    ...
    -- ✅ CORRECTED: Use the proper API function
    vim.keymap.set("n", "<C-p>", function()
      dotnet.run()  -- This is the correct function from the API
    end, { desc = "Run .NET project" })

    -- 🚀 Additional useful keybindings based on the API
    ...
    vim.keymap.set("n", "<leader>dr", function()
      dotnet.run_default()
    end, { desc = "Run default .NET project" })
  end
}
